...
plugins=(git z copypath command-not-found colored-man-pages zsh-syntax-highlighting zsh-autosuggestions you-should-use)
...
export FZF_ALT_C_OPTS="--border --preview 'tree -C {}'"
